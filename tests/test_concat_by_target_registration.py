...
class TestConcatByTargetRegistration(unittest.TestCase):
    ...
    def test_concat_by_target_schema_matches_contract(self):
        ...
        self.assertEqual(optional["image/mask_A"][0], "IMAGE,MASK")
        self.assertEqual(optional["image/mask_B"][0], "IMAGE,MASK")
        self.assertNotIn("a", optional)
        self.assertNotIn("b", optional)
